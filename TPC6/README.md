...
Foi pedido que se integrasse as funções criadas em aula num programa Python que simulasse a gestão e registo de dados meteorológicos. Neste programa, cada função é acessível através de um menu, onde o usuário consegue: 

Registar os dados relativos a cada data, verificar as temperaturas médias de cada data, verificar a temperatura mínima mais baixa do registo atual, verificar as amplitudes térmicas de cada data, obter a data com maior valor de precipitação dos registos, obter o máximo período de dias de calor consecutivos, obter um gráfico de evolução dos dados meteorológicos, guardar os dados num ficheiro e carregá-los do mesmo.
